import {
  ...
  injected,
  mock
} from "./chunk-B4HMZ7ZF.js";
import "./chunk-CLG3DRT5.js";
import "./chunk-M6JLZ5G3.js";
import {
  withRetry,
  withTimeout
} from "./chunk-FIXFT5F6.js";
import "./chunk-NYB375KC.js";
import "./chunk-MPJZBGP2.js";
import "./chunk-EPGUYEPS.js";
import "./chunk-4TYVNQA3.js";
...
import {
  ...
  hexToNumber,
  numberToHex
} from "./chunk-CLEFMBVA.js";
import "./chunk-R2SX23IL.js";
import {
  __publicField
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-UIBZBNUN.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-QA3NQP2N.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-YG7F6MGW.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-DUTEBF7C.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-K3K6AXPJ.js");
    ...
    async getProvider() {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-6NZOMYWK.js");
