...
import "../interfaces/SharedInterfaces.sol";

/**
 * @title EduCertEntryPoint
 * @notice Custom EntryPoint wrapper for EduCert system with trust score integration
 * @dev This contract wraps the standard ERC-4337 EntryPoint with EduCert-specific features
 */
contract EduCertEntryPoint is AccessControl, ReentrancyGuard {
    ...
    /**
     * @dev Enhanced handleOps with EduCert trust score integration
