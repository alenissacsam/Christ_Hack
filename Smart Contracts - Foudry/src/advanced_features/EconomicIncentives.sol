...
contract EconomicIncentives is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address _stakingToken, address _trustScore, address _verificationLogger) public initializer {
